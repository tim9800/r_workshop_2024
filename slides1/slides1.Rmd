...
Because we have `sofas_score` on both sides of statement, we modify
`sofas_score` instead of making a new variable
...
This function is useful for creating custom summaries of variables in your data.
