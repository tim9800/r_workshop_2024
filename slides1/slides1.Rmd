...
<<<<<<< HEAD
4. Reading in files and the working directory

5. Manipulating data using `tidyverse`
=======
4. Working with external data

5. Data manipulation with `tidyverse`
>>>>>>> 792319f5913ea98225663891da7314e12292d087
...
<<<<<<< HEAD
Vectors are made using the function `c()`, which is short for "combines"

```{r}
ages <- c(15, 25, 27, 18) # A numeric vector

survey_results <- c("Yes", "No", "No", "Maybe") # A character vector
=======
...
<<<<<<< HEAD
# Reading in files and the working directory
=======
...
1. Minimise RStudio and find a place, on your computer's file system, to save the contents
of this workshop
