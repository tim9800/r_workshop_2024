...
There are many more **tidy selection helpers**. Find out more about them using
`?select`
...
**Example 1**: Filter in the adults
...
There are many kinds of conditions we can use to filter the rows of a dataset
