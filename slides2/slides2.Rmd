...
Instead of setting `fill` to a fixed value, let's make the `fill` of each bar
vary based on the levels of the clinical stage variable
...
And change the layout of the bars from `stack` (the default) to `dodge`
<br>
<br>
